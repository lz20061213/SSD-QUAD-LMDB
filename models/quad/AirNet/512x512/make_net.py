...
if __name__ == '__main__':
    ...
    AirBody(net, from_layer='data', use_conv5=True)
    mbox_source_layers = ['conv3b', 'conv4b', 'conv5b']
    lr_mult = 1
    input_dim = 512
    min_sizes = [input_dim * 0.1, input_dim * 0.2, input_dim * 0.3]
    max_sizes = [input_dim * 0.3, input_dim * 0.5, input_dim * 0.7]
